...
%     else
%         if (norm(B-X(1:2))<700 && isSectorClear(agent.z,B,Opponent,angV(G-B),100)) %Если мы близки к мячу и сектор для захода свободен
...
rul_=Crul(100,50,0,0,0);
RP.Yellow(6).rul=ReactAvoidance(rul_,RP.Yellow(6),Opponent2); %Реактивные обход препятствий (не врезаться в своих).
%RP.Yellow(6).rul
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
