...
Opponent=[100,200; 400,600; -700, -300; -450, 900];
Cang=pi/4;
BallDangArea=4;
...
for i=1:szS
     ind1=min(max((1:2:szXY)+sdvigI1(i),1),szXY);
     ind2=min(max((2:2:szXY)+sdvigI2(i),1),szXY);
%     VarWeightMassive(ind1,i)=WeightMatrix(1:2:szXY)+sdvigL(i);
%     VarWeightMassive(ind2,i)=WeightMatrix(2:2:szXY)+sdvigL(i);
    VarWeightMassive(1:2:szXY,i)=WeightMatrix(ind1)+sdvigL(i);
    VarWeightMassive(2:2:szXY,i)=WeightMatrix(ind2)+sdvigL(i);
end
...
plot3(X(i)+0.8*[0,X(sdvigIp(i,R(i)))-X(i)],Y(i)+0.8*[0,Y(sdvigIp(i,R(i)))-Y(i)],WeightMassive(i)+0.8*[0,WeightMassive(sdvigIp(i,R(i)))-WeightMassive(i)],'B-')
...
plot(X(i)+0.8*[0,X(sdvigIp(i,R(i)))-X(i)],Y(i)+0.8*[0,Y(sdvigIp(i,R(i)))-Y(i)],'B-')
